...
public class Stock extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.item) {
            ...
            Intent intent = new Intent(Stock.this, Item.class);
...
//        }
            ...
            Intent intent = new Intent(Stock.this, LinkedDevices.class);
            startActivity(intent);

            return true;
        } else if (id == R.id.location) {

            Intent intent = new Intent(Stock.this, Location.class);
            startActivity(intent);

            return true;
        } else if (id == R.id.measurement_unit) {

            Intent intent = new Intent(Stock.this, MeasurementUnit.class);
            startActivity(intent);

            return true;
        } else if (id == R.id.role) {

            Intent intent = new Intent(Stock.this, Role.class);
            startActivity(intent);
